...
# Run embedding
.venv/bin/python src/embedding_clustering.py --model DeepWalkWithRegularization --dimensions 32 --num-of-walks 5 --random-walk-length 80 --cluster-number 10 --input $1.csv  --embedding-output out/embeddings/$1.csv --log-output out/cluster_means/$1.csv --cluster-mean-output out/logs/$1.csv --assignment-output out/assignment/$1.json
